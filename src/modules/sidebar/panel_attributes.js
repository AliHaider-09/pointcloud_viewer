...
class Panel{
	...
	constructor(){
		...
		this.element.innerHTML = `
			...
			<!-- Mapping section commented out
			<div class="subsection">Mapping</div>
			<select id="mappings_list"></select>
			-->
			<select id="mappings_list" style="display:none"></select>
			...
			-->
			<div class="subsubsection" id="gradient_schemes" style="display:none"></div>
			<div class="subsubsection" id="attributes_gamma_brightness_contrast" style="display:none"></div>
			<div class="subsubsection" id="attributes_scalar" style="display:none"></div>
			<div class="subsubsection" id="attributes_listing" style="display:none"></div>
			<div class="subsubsection" id="attributes_data" style="display:none"></div>
		`;
